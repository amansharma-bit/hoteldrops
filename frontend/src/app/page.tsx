      ...
      {signupPopup && (
        <div style={{
          ...
          <div style={{
            ...
            {/* Google */}
            <button onClick={handlePopupGoogle} disabled={popupLoading} style={{
              ...
              gap: 10, color: "#0f172a", marginBottom: 16,
            }}>
            ...
            <input type="email" value={popupEmail} onChange={e => setPopupEmail(e.target.value)}
              ...
              style={{ width: "100%", background: "rgba(255,255,255,0.1)", border: "1.5px solid rgba(255,255,255,0.2)", borderRadius: 10, padding: "12px 14px", fontSize: 14, color: "#fff", fontFamily: "inherit", outline: "none", marginBottom: 10 }} />
            <input type="password" value={popupPw} onChange={e => setPopupPw(e.target.value)}
              placeholder="Password (min. 8 characters)"
              style={{ width: "100%", background: "rgba(255,255,255,0.1)", border: "1.5px solid rgba(255,255,255,0.2)", borderRadius: 10, padding: "12px 14px", fontSize: 14, color: "#fff", fontFamily: "inherit", outline: "none", marginBottom: 14 }} />

            {popupErr && <div style={{ fontSize: 13, color: "#fca5a5", marginBottom: 12 }}>{popupErr}</div>}

            <button onClick={handlePopupSignup} disabled={popupLoading} style={{
              width: "100%", background: "#FCD34D", color: "#0f172a", border: "none",
              borderRadius: 10, padding: "14px", fontSize: 15, fontWeight: 700,
              cursor: popupLoading ? "not-allowed" : "pointer", fontFamily: "inherit", marginBottom: 12,
            }}>
            ...
            <p style={{ fontSize: 11, color: "rgba(255,255,255,0.25)", textAlign: "center" as const, marginTop: 12 }}>
              Already a member?{" "}
              <a href="/signin" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none" }}>Sign in</a>
            </p>
          </div>
        </div>
      )}
