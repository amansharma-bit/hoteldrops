...
export default function BusinessLoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: "'Inter',sans-serif" }}>
      ...
      {/* LEFT — solid blue brand panel */}
      <div style={{
        flex: '1 1 46%', background: BLUE,
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 440 }}>
          <h1 style={{ fontFamily: "'Sora',sans-serif", fontSize: 40, fontWeight: 800, lineHeight: 1.12, margin: 0, letterSpacing: '-0.02em' }}>
            Live rebooking on every reservation you hold
          </h1>
          <p style={{ fontSize: 15.5, lineHeight: 1.65, color: 'rgba(255,255,255,0.82)', marginTop: 22 }}>
            When a booking you've already made drops in price, rebuq catches it, confirms the room, board and cancellation terms still match, and rebooks at the lower rate — so the saving is yours, not the market's.
          </p>
        </div>
        {/* Footer */}
      ...
      <div style={{ flex: '1 1 54%', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px' }}>
        <div style={{ width: 'min(88vw, 380px)' }}>
          ...
          <input
            ...
            onFocus={(e) => (e.currentTarget.style.border = `1px solid ${BLUE}`)}
          ...
          <button
            ...
            style={{ width: '100%', border: 'none', borderRadius: 10, padding: '13px', fontSize: 14.5, fontWeight: 700, color: '#fff', cursor: loading ? 'wait' : 'pointer', background: loading ? '#66BEFF' : BLUE, transition: 'background 0.15s', fontFamily: 'inherit' }}
            onMouseEnter={(e) => !loading && (e.currentTarget.style.background = BLUE_DEEP)}
